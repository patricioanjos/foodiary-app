...
export function DailyStats({calories, proteins, carbohydrates, fats}: IGoalArcsProps) {
        ...
        <View className="justify-center items-center">
            <View className="items-center relative min-h-[172px]">
                ...
                <View className="-mt-16 justify-center items-center">
                    <Text>
                        <Text className="font-sans-regular text-support-tomato text-xl">
            ...
            <View className="p-4 w-full flex-row justify-between items-center">
                ...
                <View className="justify-center items-center w-1/3">
                    <Text className="font-sans-regular text-support-teal text-base">
                ...
                <View className="justify-center items-center w-1/3">
                    <Text className="font-sans-regular text-support-yellow text-base">
                ...
                <View className="justify-center items-center w-1/3">
                    <Text className="font-sans-regular text-support-orange text-base">
